...
: ${AMENT_CURRENT_PREFIX:="/home/cloliveira/Final_Project/RBE4540FinalProjectGroup1/project_ws/install/pcl"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pcl/environment/pythonpath.sh"
